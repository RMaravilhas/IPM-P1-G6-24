  ...
  return (
    ...
    >
      <div className="flex flex-wrap gap-5 justify-between items-start w-full max-md:max-w-full">
        ...
        <div className="flex gap-6 text-base items-center leading-tight text-center">
          ...
          <form className="flex gap-3 self-start">
            ...
            <div className="flex flex-col self-start mt-2">
              ...
              <input
                ...
                className="self-start bg-transparent border-none outline-none text-2xl"
              />
              <div
          ...
          {currentViewType === 'recipe' ? (
            <button
              ...
              className="overflow-hidden px-6 py-2 text-[#36b391] text-xl whitespace-nowrap bg-white rounded-3xl 
