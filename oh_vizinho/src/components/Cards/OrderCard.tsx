...
const OrderCard: React.FC<OrderCardProps> = ({
  ...
  return (
    <article className="p-6 w-full max-w-lg bg-stone-50 border-solid border-2 rounded-xl shadow-md flex flex-col gap-4">
      {/* Título com Destaque */}
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="text-lg font-semibold text-lime-600 bg-[#E6F7F0] px-4 py-2 rounded-md">
          {quantity}
        </div>
      </div>
